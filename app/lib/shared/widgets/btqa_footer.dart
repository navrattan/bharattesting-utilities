...
/// A persistent legal disclaimer widget for compliance
class LegalDisclaimer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(
        '⚠️ LEGAL DISCLAIMER: All data generated by BharatTesting is FAKE and for testing/development purposes only. Do not use for real-world identification, fraud, or official documents.',
